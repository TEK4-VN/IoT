...
with mp_hand.Hands(min_detection_confidence=0.5,
    ...
    while True:
        ...
        if len(lmList)!=0:
            ...
            cnt.led(total)
            if total==0:
                cv2.rectangle(image, (20, 300), (290, 425), (0, 255, 0), cv2.FILLED)
                cv2.putText(image, "0", (45, 375), cv2.FONT_HERSHEY_SIMPLEX,
                    2, (255, 0, 0), 5)
                cv2.putText(image, "off all", (100, 375), cv2.FONT_HERSHEY_SIMPLEX,
                      2, (255, 0, 0), 5)
            elif total==1:
                cv2.rectangle(image, (20, 300), (340, 425), (0, 255, 0), cv2.FILLED)
