 ...
 #include <WiFi.h>        //Use ESP8266 functions                                              
 #include <HTTPClient.h>
 #include <Wire.h>  // Only needed for Arduino 1.6.5 and earlier
 #include "SSD1306Wire.h" 
 #include "OLEDDisplayUi.h" // Include the UI lib
 #include "images.h"  // Include custom images
  SSD1306Wire  display(0x3c, 2, 4); //  D2 -> SDA and D1 -> SCL
  ...
  const char* url1 = "/apps/thinghttp/send_request?api_key=OYCWMCCF3YFPNZYN";     //Change this URL Cases
  const char* url2 = "/apps/thinghttp/send_request?api_key=NNDX004BSSGIIM38";   //Deaths
  const char* url3 = "/apps/thinghttp/send_request?api_key=QT02H17YTM14BYTH";   //Recovered
